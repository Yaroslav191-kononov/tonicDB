...
--
-- Хост: MySQL-8.0
-- Время создания: Дек 19 2025 г., 10:35
...
INSERT INTO `articles` (`id`, `title`, `tag`, `image`, `link`, `blog_id`, `type`, `date_published`, `excerpt`, `author`) VALUES
...
(11, 'Есть ли научные исследования о свойствах Анфельций?', '#faq', NULL, '#', 3, 'large', '2025-12-16', 'Да, изучение Анфельции ведется уже многие годы. Научные работы подтверждают ее биоактивные свойства, в том числе способность очищать организм, укреплять иммунитет и улучшать обменные процессы.', ''),
...
(14, 'Можно ли совмещать Анфельцию с другими средствами?', '#faq', NULL, '#', 3, 'small', '2025-12-16', 'Да, Анфельция совместима с большинством продуктов и лекарственных средств, но для достижения наилучших результатов важно подобрать индивидуальный режим приема.', '');
...
INSERT INTO `products` (`id`, `name`, `price`, `image`, `size`, `category_id`, `discription`) VALUES
(1, 'НАЗВАНИЕ', '1234', 'card2.svg', 'small', 1, NULL),
(2, 'НАЗВАНИЕ', '1234', 'card1.svg', 'big', 1, NULL),
(3, 'НАЗВАНИЕ', '1234', 'card1.svg', 'big', 1, NULL),
(4, 'НАЗВАНИЕ', '1234', 'card3.svg', 'small', 1, NULL),
(5, 'НАЗВАНИЕ', '1234', 'card4.svg', 'small', 1, NULL),
(6, 'название', '12432', 'ProductPhoto.jpg', 'small', 2, NULL),
(7, 'название', '12432', 'ProductPhoto.jpg', 'small', 2, NULL),
...
INSERT INTO `related_articles` (`id`, `article_id`, `title`, `excerpt`, `date`, `image`) VALUES
(1, 1, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-6.jpg'),
(2, 1, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-7.jpg'),
(3, 1, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-8.jpg'),
(4, 2, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-6.jpg'),
(5, 2, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-7.jpg'),
(6, 2, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-8.jpg'),
(7, 3, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-6.jpg'),
(8, 3, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-7.jpg'),
(9, 3, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-8.jpg'),
(10, 4, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-6.jpg'),
(11, 4, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-7.jpg'),
(12, 4, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-8.jpg'),
(13, 5, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-6.jpg'),
(14, 5, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-7.jpg'),
(15, 5, 'Название статьи название статьи', 'Текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст статьи текст текст статьи текст статьи', '2025-07-16', 'blog-8.jpg');
